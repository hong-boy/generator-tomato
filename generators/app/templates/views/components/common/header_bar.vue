<template>
    <el-row class="header-bar" justify="center" align="middle">
        <div class="container">
            <el-col :span="8" class="header-bar-left">
                <router-link to="/index"><img src="../../assets/image/OneNET.png" alt="OneNET"></router-link>
                <span>|</span>
                <span>{{name}}</span>
            </el-col>
            <el-col :span="13" class="header-bar-nav">
                <el-menu ref="menu" mode="horizontal" :router="true" :defaultActive="defaultMenu">
                    ...
                    <el-submenu index="/account">
                        ...
                        <el-menu-item index="/account/manager" v-if="auth4Page('/account/manager')">管理系统账号
                        </el-menu-item>
                    </el-submenu>
                    <el-submenu index="/settings">
                        ...
                        <el-menu-item index="/settings/resource" v-if="auth4Page('/settings/resource')">内容设置
                        </el-menu-item>
                        <el-menu-item index="/settings/feedback" v-if="auth4Page('/settings/feedback')">用户反馈
                        </el-menu-item>
                    </el-submenu>
                    <el-menu-item index="/demo" v-if="auth4Page('/demo')">Demo展示</el-menu-item>
                </el-menu>
            </el-col>
            <el-col :span="3" class="header-bar-right">
                <el-dropdown>
